...
#/home/vinylhub/uwsgi --psgi /home/vinylhub/vinylhub.ru/app.pl --uwsgi-socket=/home/vinylhub/vinylhub.ru/uwsgi.sock --master  --lazy-apps --processes=5
#~ --pidfile=/home/vinylhub/vinylhub.ru/uwsgi.pid --daemonize=/home/vinylhub/vinylhub.ru/log/uwsgi.log
# --threads=10 не надо для перла
...
SERVICE_ROOT=~/LoviGazelle.ru
SERVICE_SCRIPT="$SERVICE_ROOT/script/app.pl"
#~ OWNER=guest # su
#~ GROUP=guest
NAME=uwsgi
DESC=uwsgi
...
ACTION=$1
shift
DAEMON_OPTS="--psgi $SERVICE_SCRIPT --uwsgi-socket=$SOCK --master  --pidfile=$PID_FILE --daemonize=$LOG --max-requests=1000 "
#  --enable-threads -не надо для перла
# --lazy-apps --processes=5
# --http-websockets
