...
from examples https://metacpan.org/release/Net-SIP
...
sox output.wav  -c 1 -r 8000  -e u-law -t raw output.raw
sox '~/Загрузки/Dzheims_Last-Odinokii_Pastuh.mp3' -c 1 -r 8000  -e u-law -t raw  ~/пастух.mp3 --show-progress trim 00:00 00:02
----sox пастух.mp3  -c 1 -r 8000  -e u-law -t raw пастух.mp3.raw trim 0 2
sox tmc.mp3  -c 1 -r 8000  -e u-law -t raw tmc.raw
perl sip-invite_and_send.pl -d -T 10 --S ~/пастух.mp3.raw -S ~/hello.mp3.raw -S ~/tmc2.mp3.raw -S ~/repeat.mp3.raw -S ~/tmc2.mp3.raw  --username 777 --password ... --proxy=192.168.111.7 sip:777@asterisk 101
