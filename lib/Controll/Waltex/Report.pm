...
sub data {
  ...
  my %args = ('проект'=>$project, 'кошелек'=>$кошелек, 'кошелек2'=>$кошелек2, 'объект'=>$объект, 'контрагент'=>$контрагент, 'профиль'=>$профиль, 'даты'=>$date, 'интервал'=>\@interval);
...
sub все_кошельки {# сразу весь список кошельков
  ...
  $c->model->temp_view_name($c->snapshot_name);
  my %args = ('проект'=>$project, 'даты'=>$date, 'кошелек2'=>$кошелек2, 'объект'=>$объект, 'контрагент'=>$контрагент, 'профиль'=>$профиль,);
