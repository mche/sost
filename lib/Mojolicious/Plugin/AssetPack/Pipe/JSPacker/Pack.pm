...
package Mojolicious::Plugin::AssetPack::Pipe::JSPacker::Pack;
use strict;
use Data::Dumper;

use Mojolicious::Plugin::AssetPack::Pipe::JSPacker::ParseMaster;
...
#############################
    ...
    my $X_script = shift;
    my $parser = Mojolicious::Plugin::AssetPack::Pipe::JSPacker::ParseMaster->new();
    # make safe
    $parser->escapeChar("\\");
    # protect strings
    $parser->add(q/'[^'\n\r]*'/, $X_IGNORE);
