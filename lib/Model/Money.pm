...
!!!!!!!!!!!!!!!!!!!!!
Эта таблица использ для промежуточных расчетов квитков ЗП сотрудников
...
Поэтому эти записи не попадут в окончательные расчеты по сотрудникам и движению денег
*/
