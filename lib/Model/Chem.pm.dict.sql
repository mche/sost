...
/*еще расход сырья по отгрузкам*/
;

CREATE OR REPLACE  VIEW "химия"."движение продукции" AS
/* производство */
select p.id /*as "движение/id"*/, n.id as "номенклатура/id", p."№ партии", p."дата", p."количество", p."ед", p."коммент"
from 
  "химия"."продукция" p 
