...
context = {
    ...
    'contragent0_INN': u'''{%= $contragent3_INN %}''',
    'contragent0_BIK': u'''{%= $contragent3_BIK %}''',
    'contragent0_OGRNIP': u'''{%= $contragent3_OGRNIP %}''',
    'contragent0_korr_schet': u'''{%= $contragent3_korr_schet %}''',
    'contragent0_ras_schet': u'''{%= $contragent3_ras_schet %}''',
    'contragent0_bank': u'''{%= $contragent3_bank %}''',
    'contragent0_ur_addr': u'''{%= $contragent3_ur_addr %}''',
    'contragent0_post_addr': u'''{%= $contragent3_post_addr %}''',
    'contragent0_tel': u'''{%= $contragent3_tel %}''',
