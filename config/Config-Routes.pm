...
[
#~ [route=>['*foo/*bar', [foo => qr/\.php/]], to=>'main#php', name=>'php-die',],
...
#~ [route=>'/админка/доступ/роли+аршрута/:route', over=>{access=>{auth=>'only'}}, to=>'Access#route_roles', name=>'доступ/роли маршрута',],
