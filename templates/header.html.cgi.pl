...
div({-class=>"nav-wrapper valign-wrapper",},
  div({-class=>"logo left",},
    ...
    a({-class=>"left-side-nav", 'data-activates'=>"left-side-top-nav", -href=>"javascript:",},
      '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 152 152" style="height:3rem;" class="white circle"><use xlink:href="/i/img.svg?bar#logoU"></use></svg>',
    ),
  ),
