...
var routes = {
  ...
  "номенклатура/список без потомков": '/номенклатура/список+без+потомков-:root',
  
  "тмц/сохранить заявку":'/тмц/заявка/сохранить',
  "тмц/удалить заявку": '/тмц/заявка/удалить',
  "тмц/список заявок":'/тмц/заявки/список',
  "тмц/заявки с обработкой снабжения": '/тмц/заявки/обработка',
  ...
  "тмц/заявки с транспортом": '/тмц/заявки/с-транспортом',
