...
var routes = {
  ...
  "список пользователей": '/админка/доступ/список/пользователи',
  "список ролей": '/админка/доступ/список/роли',
  "список маршрутов": '/админка/доступ/список/маршруты',
  
  "сохранить пользователя": '/админка/доступ/сохранить пользователя',
},
