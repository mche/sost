...
(function () {
  ...
  .run(function($templateCache) {
    ...
    if (Vue) Vue.component('progress-indeterminate', {"data": function () { return { }}, "template": '<div :class="`progress z-depth-1 ${ color }-lighten-4`" style="height: inherit;"><div :class="`center ${ color }-text text-darken-2`">{{ message }}</div><div :class="`indeterminate ${ color }`"></div></div>', "props": ['color', 'message'],});
