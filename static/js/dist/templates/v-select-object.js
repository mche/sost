...
return [_c('h5',{staticClass:"padd-0-05 blue-text text-darken-3 relative hoverable-000",class:{'bold fs14': listItem === selected, 'fw500': listItem === highlighted,},attrs:{"class0000":" ItemClass(obj) "}},[_c('span',[_vm._v("★ "+_vm._s(listItem.$item.name))]),_vm._v(" "),_c('span',{staticClass:"grey-text fs7",staticStyle:{"position":"absolute","right":"0","bottom":"0"}},[_vm._v("#"+_vm._s(listItem.id))])])]}}],null,false,4103620602)}):_vm._e()],1)}
var staticRenderFns = []
