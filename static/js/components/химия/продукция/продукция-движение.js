(function () {'use strict';
/**/
var moduleName = "Химия::Продукция::Движение";
try {angular.module(moduleName); return;} catch(e) { } 
var module = angular.module(moduleName, []);/// 'EventBus' 
module
.factory('$ХимияПродукцияДвижение', function($templateCache, $http,  appRoutes, $Список /*, $EventBus$timeout,$rootScope, , /**$compile, Util */) {// factory
...
LoadData(){
  var vm = this;
  var loader = new $Список(appRoutes.urlFor('химия/движение продукции'));
...
const $Конструктор = function (){
  let $this = this;
  $Компонент.template = $templateCache.get('компонент/химия/продукция/движение');/// только в конструкторе
  return $Компонент;
};
