...
var module = angular.module(moduleName, ['AuthTimer', 'AppTplCache', 'appRoutes', 'Util',  'TransportAskTable', 'ContragentItem']);//
...
var Data  = function($http, appRoutes, Util, ContragentData){
  ...
  var factory = {
    ...
    "наши ТК": [1393, 10883, 971, 207975, 16307],// транпортные конторы: останина  капитал гарантия шутемов техдоргрупп
